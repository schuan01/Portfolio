...
export const portfolioData: PortfolioItem[] = [
  ...
  },
  {
    ...
    description: 'Dauntless was a massively multiplayer RPG where you and other Slayers teamed up to hunt powerful creatures known as Behemoths. Explore the furthest reaches of the Shattered Isles as you quest, craft, and fight to forge your legacy as a legendary Slayer.',
    area: 'Game Developer',
    platform: 'PC & Consoles',
